...
sudo sed -i -e 's/\(ip\ -[46]\ route\ add\ default.*\)/#\1/' /etc/udhcpc/post-renew/eth-eni-hook
# disable dhcp on hot-plug eni interfaces
sudo sed -i -e '/dhcp/d'  /etc/network/interfaces.d/DEFAULT
